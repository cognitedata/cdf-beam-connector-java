...
public abstract class PostJsonListRequestProvider extends GenericRequestProvider {
    ...
    public static Builder builder() {
        return new com.cognite.beam.io.servicesV1.request.AutoValue_PostJsonListRequestProvider.Builder()
    ...
    public PostJsonListRequestProvider withRequestParameters(RequestParameters parameters) {
