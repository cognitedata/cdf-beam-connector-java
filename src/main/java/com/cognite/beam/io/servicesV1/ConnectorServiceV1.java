...
import com.cognite.beam.io.servicesV1.executor.FileBinaryRequestExecutor;
import com.cognite.beam.io.servicesV1.parser.ItemParser;

import com.cognite.beam.io.config.ProjectConfig;
import com.cognite.beam.io.dto.*;
import com.cognite.beam.io.servicesV1.executor.RequestExecutor;
import com.cognite.beam.io.servicesV1.parser.FileParser;
import com.cognite.beam.io.servicesV1.parser.LoginStatusParser;
import com.cognite.beam.io.servicesV1.request.*;
import com.cognite.beam.io.servicesV1.response.*;
...
public abstract class ConnectorServiceV1 implements Serializable {
    ...
    public static Builder builder() {
        return new com.cognite.beam.io.servicesV1.AutoValue_ConnectorServiceV1.Builder()
    ...
    abstract static class ConnectorBase implements Serializable {
        // 500 and 502 are a temporary mitigation for the cdp api
        static final ImmutableList<Integer> RETRIABLE_RESPONSE_CODES = ImmutableList.of(429, 503, 500, 502);
        ...
        static final ForkJoinPool DEFAULT_FORK_JOIN_POOL =
                new ForkJoinPool(Runtime.getRuntime().availableProcessors() * 8);
        ...
        abstract static class Builder<B extends Builder<B>> {
            ...
            abstract B setMaxRetries(int value);
            /*
            abstract B setHttpClient(OkHttpClient value);
            abstract B setExecutorService(ExecutorService value);
    ...
    public abstract static class ResultFutureIterator<T>
        ...
        private static <T> Builder<T> builder() {
            return new com.cognite.beam.io.servicesV1.AutoValue_ConnectorServiceV1_ResultFutureIterator.Builder<T>()
    ...
    public static abstract class SingleRequestItemReader<T> extends ConnectorBase implements ItemReader<T> {
        ...
        static <T> Builder<T> builder() {
            return new com.cognite.beam.io.servicesV1.AutoValue_ConnectorServiceV1_SingleRequestItemReader.Builder<T>()
                    .setMaxRetries(ConnectorConstants.DEFAULT_MAX_RETRIES)
                    .setRequestExecutor(DEFAULT_REQUEST_EXECUTOR);
        }
    ...
    public static abstract class AsyncJobReader<T> extends ConnectorBase implements Connector<T>, ItemReader<T> {
        ...
        static <T> Builder<T> builder() {
            return new com.cognite.beam.io.servicesV1.AutoValue_ConnectorServiceV1_AsyncJobReader.Builder<T>()
                    .setMaxRetries(ConnectorConstants.DEFAULT_MAX_RETRIES)
    ...
    public static abstract class ItemWriter extends ConnectorBase {
        ...
        static Builder builder() {
            return new com.cognite.beam.io.servicesV1.AutoValue_ConnectorServiceV1_ItemWriter.Builder()
                    .setMaxRetries(ConnectorConstants.DEFAULT_MAX_RETRIES)
                    .setRequestExecutor(DEFAULT_REQUEST_EXECUTOR)
    ...
    public static abstract class FileBinaryReader extends ConnectorBase {
        ...
        static Builder builder() {
            return new com.cognite.beam.io.servicesV1.AutoValue_ConnectorServiceV1_FileBinaryReader.Builder()
                    .setAppIdentifier(DEFAULT_APP_IDENTIFIER)
    ...
    public static abstract class FileWriter extends ConnectorBase {
        ...
        static Builder builder() {
            return new com.cognite.beam.io.servicesV1.AutoValue_ConnectorServiceV1_FileWriter.Builder()
                    .setAppIdentifier(DEFAULT_APP_IDENTIFIER)
                    .setSessionIdentifier(DEFAULT_SESSION_IDENTIFIER)
                    .setMaxRetries(ConnectorConstants.DEFAULT_MAX_RETRIES)
                    .setRequestExecutor(DEFAULT_REQUEST_EXECUTOR)
