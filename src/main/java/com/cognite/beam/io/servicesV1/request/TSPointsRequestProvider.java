...
public abstract class TSPointsRequestProvider extends GenericRequestProvider {
    ...
    public static Builder builder() {
        return new com.cognite.beam.io.servicesV1.request.AutoValue_TSPointsRequestProvider.Builder()
    ...
    public TSPointsRequestProvider withRequestParameters(RequestParameters parameters) {
