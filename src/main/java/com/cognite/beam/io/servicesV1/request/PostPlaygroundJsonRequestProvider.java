...
public abstract class PostPlaygroundJsonRequestProvider extends GenericPlaygroundRequestProvider {
    ...
    public static com.cognite.beam.io.servicesV1.request.PostPlaygroundJsonRequestProvider.Builder builder() {
        return new com.cognite.beam.io.servicesV1.request.AutoValue_PostPlaygroundJsonRequestProvider.Builder()
    ...
    public abstract com.cognite.beam.io.servicesV1.request.PostPlaygroundJsonRequestProvider.Builder toBuilder();

    public com.cognite.beam.io.servicesV1.request.PostPlaygroundJsonRequestProvider withRequestParameters(RequestParameters parameters) {
    ...
    @AutoValue.Builder
    public static abstract class Builder extends GenericPlaygroundRequestProvider.Builder<com.cognite.beam.io.servicesV1.request.PostPlaygroundJsonRequestProvider.Builder>{
        public abstract com.cognite.beam.io.servicesV1.request.PostPlaygroundJsonRequestProvider build();
    }
}
