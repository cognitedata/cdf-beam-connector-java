...
import com.cognite.beam.io.servicesV1.response.JsonErrorItemResponseParser;
import com.cognite.beam.io.servicesV1.response.JsonStringAttributeResponseParser;
import com.cognite.beam.io.servicesV1.response.ResponseParser;
...
public abstract class ResponseItems<T> implements Serializable {
    static <T> Builder<T> builder() {
        return new com.cognite.beam.io.servicesV1.AutoValue_ResponseItems.Builder<T>()
