 ...
 *
 */
public class ListSequencesRowsFn extends ListItemsBaseFn<SequenceBody> {
    public ListSequencesRowsFn(Hints hints,
    ...
    @Override
    protected Iterator<List<SequenceBody>> listItems(CogniteClient client,
